"""home_trend_24478 URL Configuration
...
admin.site.site_header = "Home Trend"
admin.site.site_title = "Home Trend Admin Portal"
admin.site.index_title = "Home Trend Admin"

# swagger
api_info = openapi.Info(
    title="Home Trend API",
    default_version="v1",
    description="API documentation for Home Trend App",
)
